...
> طراحی نسخه بعدی ناوراکار تأیید و در [مستندات پروژه طراحی V2](docs/design-v2/README.md) ثبت شده است. این سند شامل قالب وب، پنل مدیریت، داشبوردهای فروش و محتوا، نسخه موبایل و نرم‌افزار Android است.
